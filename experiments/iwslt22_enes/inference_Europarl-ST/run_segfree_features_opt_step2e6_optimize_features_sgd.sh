...
--features $features_folder/direct_count/feature.json \
$features_folder/fairseq_reverse_scorer/reverse_model_feature.json \
$features_folder/length_src_noexp/feature.json \
$features_folder/length_src2tgt_noexp/feature.json \
$features_folder/length_tgt2src_noexp/feature.json \
--method sgd \
--optimizer adam \
--learning_rate 1e-3 \
--epochs 800 \
