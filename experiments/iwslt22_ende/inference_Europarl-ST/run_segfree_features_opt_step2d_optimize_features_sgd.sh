...
name=rev_plus_linear_models_morder"$morder"_stdorder"$stdorder"_iqr$iqr
...
--features $features_folder/normal_linear_models_morder"$morder"_stdorder"$stdorder"_iqr$iqr/feature.json \
