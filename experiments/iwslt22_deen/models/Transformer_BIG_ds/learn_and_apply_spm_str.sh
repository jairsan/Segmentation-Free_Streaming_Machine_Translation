...
function apply_spm {
    prefix=$1
    lang=$2
    spm_encode --model=$CORPUS_FOLDER/spm.model --vocabulary $CORPUS_FOLDER/spm.vocab.$lang --vocabulary_threshold=50 --output_format=piece < $CORPUS_FOLDER/$prefix.prepro.$lang > $CORPUS_FOLDER/$prefix.prepro.spm.$lang
