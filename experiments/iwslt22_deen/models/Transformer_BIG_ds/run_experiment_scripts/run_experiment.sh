...
qsubmit -n p$RUN$CORPUS -m 24 ./preprocess_corpus.sh
...
qsubmit -n t$RUN$CORPUS -w bin$RUN$CORPUS -gmem $GPU_MEM -gcards 1 -m 16 ./train_model_"$TOOLKIT"_$MODEL_CONFIG.sh
