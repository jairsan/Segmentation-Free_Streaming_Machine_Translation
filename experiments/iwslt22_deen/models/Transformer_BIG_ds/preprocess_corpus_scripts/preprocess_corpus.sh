...
if [ "$TRUECASE" = true ]; then
    cat $CORPUS_FOLDER/$ORIG_TRAIN_PREFIX.$SOURCE_LANG_SUFFIX | $moses_scripts/tokenizer/normalize-punctuation.perl -l $SOURCE_LANG_SUFFIX | $moses_scripts/tokenizer/tokenizer.perl -a -l $SOURCE_LANG_SUFFIX -protected /home/jiranzo/trabajo/git/nmt-scripts/tokenizer_protected_patterns > $CORPUS_FOLDER/$ORIG_TRAIN_PREFIX.tmp.$SOURCE_LANG_SUFFIX
    cat $CORPUS_FOLDER/$ORIG_TRAIN_PREFIX.$TARGET_LANG_SUFFIX | $moses_scripts/tokenizer/normalize-punctuation.perl -l $TARGET_LANG_SUFFIX | $moses_scripts/tokenizer/tokenizer.perl -a -l $TARGET_LANG_SUFFIX -protected /home/jiranzo/trabajo/git/nmt-scripts/tokenizer_protected_patterns > $CORPUS_FOLDER/$ORIG_TRAIN_PREFIX.tmp.$TARGET_LANG_SUFFIX
    ...
    ./preprocess_file.sh -t $CORPUS_FOLDER/truecase-model.$SOURCE_LANG_SUFFIX -- $CORPUS_FOLDER/$ORIG_DEV_PREFIX $SOURCE_LANG_SUFFIX
    ./preprocess_file.sh -t $CORPUS_FOLDER/truecase-model.$TARGET_LANG_SUFFIX -- $CORPUS_FOLDER/$ORIG_DEV_PREFIX $TARGET_LANG_SUFFIX
    ./preprocess_file.sh -t $CORPUS_FOLDER/truecase-model.$SOURCE_LANG_SUFFIX -- $CORPUS_FOLDER/$ORIG_TEST_PREFIX $SOURCE_LANG_SUFFIX
    ./preprocess_file.sh -t $CORPUS_FOLDER/truecase-model.$TARGET_LANG_SUFFIX -- $CORPUS_FOLDER/$ORIG_TEST_PREFIX $TARGET_LANG_SUFFIX
   
else
    #Preprocess train,dev and test data
    ./preprocess_file.sh -- $CORPUS_FOLDER/$ORIG_TRAIN_PREFIX $SOURCE_LANG_SUFFIX
    ./preprocess_file.sh -- $CORPUS_FOLDER/$ORIG_TRAIN_PREFIX $TARGET_LANG_SUFFIX
    ./preprocess_file.sh -- $CORPUS_FOLDER/$ORIG_DEV_PREFIX $SOURCE_LANG_SUFFIX
    ./preprocess_file.sh -- $CORPUS_FOLDER/$ORIG_DEV_PREFIX $TARGET_LANG_SUFFIX
    ./preprocess_file.sh -- $CORPUS_FOLDER/$ORIG_TEST_PREFIX $SOURCE_LANG_SUFFIX
    ./preprocess_file.sh -- $CORPUS_FOLDER/$ORIG_TEST_PREFIX $TARGET_LANG_SUFFIX
