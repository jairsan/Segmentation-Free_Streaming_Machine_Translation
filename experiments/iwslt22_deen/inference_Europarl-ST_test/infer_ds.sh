...
do
    ...
    do
        ...
        --segmenter_checkpoint /scratch/jiranzotmp/trabajo/SegmentationFree/iwslt22_deen/segmenter_models_MuST-C.v2/"$segmenter_config"."$segmenter_max_len"."$segmenter_future_window"/model.best.pt \
