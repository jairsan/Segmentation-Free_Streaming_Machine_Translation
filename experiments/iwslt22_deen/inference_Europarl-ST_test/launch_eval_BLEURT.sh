...
for fname in slidingwindow;
do
    ./eval_BLEURT_sliding_windows.sh $SRC_REFERENCE_SET_LIST $TGT_REFERENCE_SET_LIST $fname $SET_NAME $OUTPUT_FOLDER_ROOT > eval_results_BLEURT/$fname.dat
done
